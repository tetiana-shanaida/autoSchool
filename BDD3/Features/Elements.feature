...
Scenario Outline: Fill in TextBox form with correct data
	...
	Then name:"<name>", email:<email>, currentAddress:<currentAddress>, permanentAddress:<permanentAddress> are displayed in the appeared table
Examples:
...
Scenario Outline: Buttons section
	Given user is on Buttons page
	When user clicks on button <name>
